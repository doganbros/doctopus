...
Integrating Jitsi with Octopus
------------------------------

* This .lua module for Jitsi Meet manages the integration between octopus and Jitsi. It enables Jitsi to send reports to Octopus. To enable it, follow the instructions below.
...
Integrating the RTMP server with Octopus
=====================================
