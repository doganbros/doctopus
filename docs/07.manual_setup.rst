...
The module is included in the package.json file within the module. Therefore, you are able to simply follow the promtps as shown;
...
* This .lua module for Jitsi Meet manages the integration between octopus and Jitsi. It enables Jitsi to send reports to Purpie. To enable it, follow the instructions below.
...
* Inside the docker container, run ``'CREATE DATABASE octopus'`` to create your Purpie database.
